...
<%@page import="com.loo.employee.domain.PageBean"%>
...
%>
<tr>
<td align="center"><%=departments.get(i).getDname() %></td>
<td align="center"><a href="${pageContext.request.contextPath}/department_edit.action?did=<%=departments.get(i).getDid()%>"><img src="${pageContext.request.contextPath}/images/编辑.png"/></a></td>
<td align="center"><a href="${pageContext.request.contextPath}/department_delete.action?did=<%=departments.get(i).getDid()%>">删除</a></td>
</tr>
<%}} %>
